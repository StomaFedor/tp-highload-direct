...
| Таблица | Кол-во записей | Примерный размер записи | Объем данных |
| ------- | -------------- | ----------------------- | ------------ |
| users   | 1.5*10^6 | 100 Байт | 143 Мб |
| sessions   | 1.5*10^6 | 4100 Байт | 5.7 Гб|
| companies   | 3*10^6 | 100 Байт | 286 Мб|
| ads   | 1.653*10^9 | 1500 Байт | 2.26 Тб |
| file_info   | 830*10^6 | 20 Байт | 15 Гб|
| phrases   | 410*10^9 | 20 Байт | 7.5 Тб |
| keywords   | 1653*10^9 | 26 Байт | 39 Тб |
| files   | 830*10^6 | 2.048*10^6 Байт | 1510 Тб |
| statistics_keyphases | 410*10^9 | 24 Байт | 8.9 Тб |
| statistics* | 39.672*10^9 | 30 Байт | 1.08 Тб |
